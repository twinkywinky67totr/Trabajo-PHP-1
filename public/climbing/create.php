    ...
    <div class="container">
        <form action="" method="POST" enctype="multipart/form-data">
            <h2>Crear ruta de escalada</h2>
                ...
                <?php endif; ?>
            <label>Nombre de la escalada:</label>
            ...
            <input type="number" step="0.1" min="0" name="distancia" value="<?php echo $_POST['distancia'] ?? ''; ?>"><br>
            ...
            <input type="number" step="0.1" min="0" name="duracion" value="<?php echo $_POST['duracion'] ?? ''; ?>"><br>
            ...
            <button type="submit">Crear escalada</button>
        </form>
